...
api: 'POST /teams/{team_id}/chargers/{charger_id}/commands/start'
description: 'Starts a charging session on the specified connector'
---
...
<ParamField body="id_tag" type="string" required hidden />
...
<Tabs>
  ...
  <Tab title="Body">
    <ParamField body="connector_id" type="integer">
      The connector to start charging on
    </ParamField>
    <ParamField body="id_tag" type="string" required>
      The id tag that the transaction needs to be started with
    </ParamField>
  </Tab>
</Tabs>
