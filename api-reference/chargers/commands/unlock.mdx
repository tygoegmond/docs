...
api: 'POST /teams/{team_id}/chargers/{charger_id}/commands/unlock'
description: 'Unlocks a connector'
---
...
<Tabs>
  ...
  <Tab title="Body">
    <ParamField body="connector_id" type="integer" required>
      The connector to unlock. If not specified, the whole charger will be unlocked.
    </ParamField>
  </Tab>
</Tabs>
