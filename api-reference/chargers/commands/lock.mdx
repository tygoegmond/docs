---
title: 'Lock Connector'
api: 'POST /teams/{team_id}/chargers/{charger_id}/commands/lock'
description: 'Locks a connector. If no connector is specified, the whole charger will be locked.'
---
...
<Tabs>
  ...
  <Tab title="Body">
    <ParamField body="connector_id" type="integer" required>
      The connector to lock. If not specified, the whole charger will be locked.
    </ParamField>
  </Tab>
</Tabs>
